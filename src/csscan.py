...
def main(argv):
    global c, o_assume_powered_on, o_lock, o_max_devices, o_show_all_status, o_show_authstatus, o_show_integration, o_show_programming, o_show_sample, o_unlock, o_verbose
